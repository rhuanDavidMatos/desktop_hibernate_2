...
public class UsuarioDaoImpl extends BaseDaoImpl<Usuario, Long> implements UsuarioDao, Serializable {
    ...
    @Override
    public List<Usuario> listaTodo(Session sessao) throws HibernateException {
    ...
    public void atualizarUltimoAcesso(Long id, Session sessao) throws HibernateException {
        ...
        Query hql = sessao.createQuery("update Usuario set ultimo_acesso = current_date() where id = :id");
