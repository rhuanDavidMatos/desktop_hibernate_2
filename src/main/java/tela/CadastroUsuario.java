...
public class CadastroUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lb_perfil.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        painel_principalLayout.setHorizontalGroup(
            ...
            .addGroup(painel_principalLayout.createSequentialGroup()
                .addGroup(painel_principalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(lb_login, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lb_nome, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lb_perfil, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE))
...
//        String valor1 = comboPerfil.getSelectedItem().toString();
//        int indice = comboPerfil.getSelectedIndex();
        if (!validarCampo()) {
            ...
            try {
                ...
                if (e.getCause().toString().contains("usuario.usuario_email")) {
                    JOptionPane.showMessageDialog(null, "Já existe um usuário com e-mail");
                }
